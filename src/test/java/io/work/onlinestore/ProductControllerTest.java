...
public class ProductControllerTest {
    ...
    @Test
    public void test_getProductByProductId_invalidProductId_negativeValue() throws Exception {
        Integer productId = -1;
    ...
    public void test_createProduct_invalidProductName_empty() throws Exception {
        ...
        String empty = "";
        // invalid
        when(product.getProductName()).thenReturn(empty);
    ...
    public void test_createProduct_invalidProductName_blank() throws Exception {
        ...
        String blank = "    ";
        // invalid
        when(product.getProductName()).thenReturn(blank);
    ...
    public void test_createProduct_invalidProductDescription_empty() throws Exception {
        ...
        String empty = "";
        // invalid
        when(product.getProductDescription()).thenReturn(empty);
    ...
    public void test_createProduct_invalidProductDescription_blank() throws Exception {
        ...
        String blank = "    ";
        // invalid
        when(product.getProductDescription()).thenReturn(blank);
